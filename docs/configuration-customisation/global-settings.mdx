...
<Frame>
<img src="/images/vk-settings.png" alt="Duck Kanban global settings page showing theme options, agent configuration, and GitHub integration settings" />
</Frame>
...
- Status synchronisation directly from Duck Kanban
...
Enable or disable telemetry data collection to help improve Duck Kanban.
