...
4. Authorize Duck Kanban in your browser
5. Return to complete the setup

**Required Permissions**: Duck Kanban needs access to your repositories (`repo`), basic profile info (`read:user`), and email address (`user:email`) for Git commits.
