...
description: "Complete guide to all coding agents supported by Duck Kanban, including installation and authentication instructions"
---

Duck Kanban integrates with a variety of coding agents. These agents are available via `npx` and can be selected when creating task attempts.
...
## Authentication
You need to authenticate with Amp outside of Duck Kanban before using it. Please follow the authentication instructions on the [Amp Owner's Manual](https://ampcode.com/manual#install).
</Accordion>
...
## Authentication
You need to authenticate with Claude Code outside of Duck Kanban before using it. Please follow the authentication instructions on the [Claude Code GitHub page](https://github.com/anthropics/claude-code).
</Accordion>
...
## Authentication
Authenticate and configure CCR outside of Duck Kanban. Follow the instructions on the CCR GitHub repo:
...
## Configure Duck Kanban

Duck Kanban does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in Duck Kanban

<Frame>
<img src="/images/vk-ccr-agent-config.png" alt="Claude Code agent configuration in Duck Kanban" />
</Frame>

## Using CCR in Duck Kanban
...
## Authentication
You need to authenticate with Gemini CLI outside of Duck Kanban before using it. Please follow the authentication instructions on the [Gemini CLI GitHub page](https://github.com/google-gemini/gemini-cli).
</Accordion>
...
## Authentication
You need to authenticate with SST OpenCode outside of Duck Kanban before using it. Please follow the authentication instructions on the [SST OpenCode GitHub page](https://github.com/sst/opencode).
</Accordion>
...
## Authentication
You need to authenticate with Qwen outside of Duck Kanban before using it. Please follow the authentication instructions in the official Qwen documentation: https://github.com/QwenLM/qwen-code
</Accordion>
