...
<Tip>
For detailed setup instructions and examples, see the [Duck Kanban MCP Server](/integrations/duck-kanban-mcp-server) documentation.
</Tip>
...
The MCP client will automatically generate structured tasks in your Duck Kanban project based on this description.
