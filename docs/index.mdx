---
title: "Duck Kanban Documentation"
...
Duck Kanban transforms how developers work with AI coding agents by providing:
...
Ready to get started? Follow our getting started guide to install and configure Duck Kanban:

<Card title="Get Started" icon="rocket" href="/getting-started">
  Install Duck Kanban and complete the setup process in minutes
</Card>
