...
Run duck kanban instantly without installation:
...
Duck Kanban is a modern project management tool designed specifically for developers. It helps you organize your coding projects with kanban-style task management while providing powerful integrations with git repositories and AI coding agents.
...
Duck Kanban provides a complete project management experience with these key capabilities:
...
Duck Kanban supports customization through its configuration system:
